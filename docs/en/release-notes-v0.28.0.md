...
# prepared head 565530e5c965d55335790c9446ef0686988d14c8
dotnet src/IntentSystem.Cli/bin/Release/net10.0/IntentSystem.Cli.dll --version
...
- G754 — PR #1641; merge commit `6ea81ac85e5fc104d5cd954766c916445f751183`.
...
- G755 — PR #1643; merge commit `9a30e95accc9d92d56ba0bdb62b1974ec7ab8302`.
...
- G756 — PR #1646; merge commit `ec261ec4c16454d122a3baec0d48393a4245f513`.
...
- G757 — PR #1648; merge commit `071ccf2c988e6244633c0971c8098fbd31b17093`.
...
- G758 — PR #1652; merge commit `145c5a43c031353a5e5ad4d7ea9eb3fb7365304c`.
...
- G759 — PR #1650; merge commit `c6e6922e8ca89520465adfa8f69375eefd5d4fa6`.
  **Operator-observable outcome:** file-backed delegation tells the recipient
  ...
  unchanged.
- G760 — PR #1653; merge commit `5d553b7a0aeecf8d9939080eada9772963fe35c8`.
...
- G761 — PR #1660; merge commit `5a6e850412beb5cd515991b3486022e457726f6a`.
...
- G762 — PR #1659; merge commit `ff11a355377fe2b1698cce1e14f39d8c79c20bd5`.
...
- G763 — PR #1667; merge commit `6cc2b05127f7dc8c9080e425eb5af8e0e099ace7`.
  **Operator-observable outcome:** stranded metadata-branch claims can be
  reported and migrated with remote-receipt confirmation.
- G764 — PR #1666; merge commit `642a86626f95fe271be663fca9d79240a58e6fd7`.
...
- G765 — PR #1670; merge commit `db5394d75e267e17606f9a5fb96b3607ec58b435`.
  **Operator-observable outcome:** persistence metadata, keep-versus-legacy
  ...
  execution.
- G766 — PR #1671; merge commit `7adb2b5cac8090865d19c864842dbed48ffab7d2`.
...
- G767 — PR #1673; merge commit `4dcf1916a94dfb871a1249fd60a3a4569b0a032c`.
...
- G768 — PR #1676; merge commit `af8b82c37c27ff319c7468084b8ac59590f887fb`.
...
- G769 — PR #1677; merge commit `a92a53fda2f8901e49b0e60d5d7c00d5c2a6c324`.
...
- G770 — PR #1680; merge commit `b111fc644dfca24b911c26eef6bad9c784ad6cd4`.
...
- G771 — PR #1682; merge commit `565530e5c965d55335790c9446ef0686988d14c8`.
