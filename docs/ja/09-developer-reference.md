...
`0.11.2` です。出荷範囲と bump 根拠は `v0.11.2` の release-prep packet が
[DRAFT ノート](release-notes-v0.11.2.md)を置き換えるまで意図的に未確定です。
直前の出荷範囲は [release-notes-v0.11.1.md](release-notes-v0.11.1.md) を参照してください。

**リリース準備検証(`v0.11.2` release-preparation PR のマージ前に実行):**
...
#   期待する形: intent-cli 0.11.2-<sha>-G<unit>   (古いリテラルではない)
...
# 4. G475、v0.11.2 release-note check、release/version guard を確認。
