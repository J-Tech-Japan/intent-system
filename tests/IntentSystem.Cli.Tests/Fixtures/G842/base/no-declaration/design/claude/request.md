...
cd '{{G842_WORKSPACE_ROOT}}/request-markdown' && claude -p --permission-mode plan --disallowedTools Edit,Write,NotebookEdit --output-format json --json-schema "$(cat '{{G842_WORKSPACE_ROOT}}/request-markdown/verdict.schema.json')" < '{{G842_WORKSPACE_ROOT}}/request-markdown/prompt.md' > '{{G842_WORKSPACE_ROOT}}/request-markdown/verdict.raw.json'
```
