...
cursor-agent -p --mode ask --sandbox enabled --trust --workspace '{{G842_WORKSPACE_ROOT}}/clone' --output-format json "$(cat '{{G842_WORKSPACE_ROOT}}/request-markdown/prompt.md')" > '{{G842_WORKSPACE_ROOT}}/request-markdown/verdict.raw.json'
```
