...
public sealed class ClarificationInboxTests
{
    ...
    public void GetPendingForUnit_GivenOpenAndResolvedClarifications_ReturnsOnlyOpenItemsForUnit()
    {
        ...
        [
            CreateItem("clar-1", "A2", ClarificationStatus.Open),
            CreateItem("clar-2", "A2", ClarificationStatus.Answered),
            CreateItem("clar-3", "B1", ClarificationStatus.Open)
        ];
    ...
    public void HasPendingClarifications_GivenOnlyResolvedClarificationsForUnit_ReturnsFalse()
    {
        IReadOnlyList<ClarificationItem> items =
        [
            CreateItem("clar-1", "A2", ClarificationStatus.Answered),
            CreateItem("clar-2", "A2", ClarificationStatus.Applied),
            CreateItem("clar-3", "A2", ClarificationStatus.Cancelled)
        ];
    ...
    {
        IReadOnlyList<ClarificationItem> items = [CreateItem("clar-1", "A2", ClarificationStatus.Open)];
