...
public sealed class ClarifyArchitectureTests
{
    [Fact]
    public void SerializationInfrastructure_DoesNotExposeClarifyJsonOptionsAsPublicApi()
    {
        var optionsType = typeof(ClarificationSerializer).Assembly
            .GetType("IntentSystem.Clarify.Serialization.ClarifyJsonOptions");
