...
internal static class SessionLayerFragments
{
    ...
    [
        ...
        Fragment(
            S1,
            Descriptive("G666/G689 preview-through-1.x applies the three-layer approval model."),
            Scaffold(" "),
            Descriptive("G689's shell-command class extracts command payloads but keeps all shell answer authority orchestration-only."),
            Scaffold(" "),
        ...
        Fragment(
            S1,
            Operative("> **Detection, adjudication, and escalation boundary (G682/G683):** the design thread never answers a dialog."),
            Scaffold(" "),
            ...
            Scaffold(" "),
            Operative("Only a validated matched pre-approve permits orchestration's audited exact-scope answer.")),
        Fragment(S1, Operative("- **confirmations of work the design thread itself requested** — verify: answer only when an exact registry class matches a validated pre-approve rule; orchestration audits and executes only its recorded scope, and design never answers it.")),
        Fragment(S1, Operative("- **command approvals verified read-only** — verify: for non-shell attended cases only, answer through the same exact registry + validated pre-approve + durable-audit path; G689 shell-command is not read-only authority even for project-test, so it requires orchestration-only scoped policy for every AST segment; otherwise escalate.")),
        Fragment(
            S1,
        ...
        Fragment(
            S1,
            Operative("- **operator-preauthorized mode changes** — verify: preauthorization alone is insufficient: require exact registry class, validated rule, durable audit, and registry-bounded orchestration execution."),
            Scaffold(" "),
            Operative("Unknown text escalates; design never answers.")),
    ...
    [
        ...
        Fragment("design_workspace_supervision", Operative("answer only when an exact registry class matches a validated pre-approve rule; orchestration audits and executes only its recorded scope, and design never answers it.")),
        Fragment("design_workspace_supervision", Descriptive("command approvals verified read-only")),
        Fragment("design_workspace_supervision", Operative("for non-shell attended cases only, answer through the same exact registry + validated pre-approve + durable-audit path; G689 shell-command is not read-only authority even for project-test, so it requires orchestration-only scoped policy for every AST segment; otherwise escalate.")),
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("preauthorization alone is insufficient: require exact registry class, validated rule, durable audit, and registry-bounded orchestration execution."),
            Scaffold(" "),
            Operative("Unknown text escalates; design never answers.")),
