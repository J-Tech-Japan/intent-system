...
internal static class SessionLayerFragments
{
    ...
    [
        ...
        Fragment(
            ...
            Scaffold(" "),
            Operative("G683 supervision emits exact recipe-registry classes plus observed text; unknown text stays escalate-only."),
            Scaffold(" "),
        ...
        Fragment(S1, Operative("- **command approvals verified read-only** — verify: answer only through the same exact registry + validated pre-approve + durable-audit path; otherwise escalate, and design never answers it.")),
        Fragment(
            S1,
    ...
    [
        ...
        Fragment("design_workspace_supervision", Operative("answer only through the same exact registry + validated pre-approve + durable-audit path; otherwise escalate, and design never answers it.")),
