...
internal static class SessionLayerFragments
{
    ...
    [
        ...
        Fragment(
            S1,
            Descriptive("G666 preview-through-1.x applies the three-layer approval model."),
            Scaffold(" "),
            ...
            Scaffold(" "),
            Operative("It records blocking waits and routes them to orchestration; it never answers a dialog or relays keystrokes."),
            Scaffold(" "),
        ...
        Fragment(S1, Operative("- BLOCKING DIALOGS — detect and record the wait, then route it to orchestration; design never answers or relays keys.")),
        Fragment(
            S1,
        ...
        Fragment(
            ...
            Scaffold(" "),
            Operative("A blocking dialog is recorded and routed to orchestration under the durable per-team policy; design never answers it."),
            Scaffold(" "),
        ...
        Fragment(
            S1,
            Operative("> **Detection and adjudication boundary:** the design thread never answers a dialog."),
            Scaffold(" "),
            Operative("Structured supervision may record enough evidence to name the observed and recorded launch shapes, then orchestration alone adjudicates a residual prompt under a matching durable policy rule."),
            Scaffold(" "),
            Operative("If no rule matches, escalation is the only action.")),
        Fragment(
            S1,
            Operative("- **confirmations of work the design thread itself requested** — verify: orchestration may adjudicate only when this exact prompt class and agent kind are recorded in the durable per-team policy; design never answers it.")),
        Fragment(
            S1,
            Operative("- **command approvals verified read-only** — verify: orchestration may adjudicate only when the durable policy names this exact class and agent kind."),
            Scaffold(" "),
            Operative("Anything unmatched escalates; design never answers it.")),
        Fragment(
            S1,
            Operative("- **trust screens for hooks the design thread itself installed** — verify: the recorded recipe should eliminate this routine screen."),
            Scaffold(" "),
            Operative("If it remains, orchestration may adjudicate only under an exact durable policy match; design never accepts it.")),
        Fragment(
            S1,
            Operative("- **operator-preauthorized mode changes** — verify: the operator must have recorded this exact agent-kind and prompt-class pair before the wait."),
            Scaffold(" "),
            Operative("Orchestration owns adjudication; design never relays the resulting key.")),
        ...
        Fragment(
            ...
            Scaffold(" "),
            Operative("It never answers residual approval dialogs or relays keystrokes."),
            Scaffold(" "),
    ...
    [
        ...
        Fragment("design_workspace_supervision", Operative("BLOCKING DIALOGS — detect and record the wait, then route it to orchestration; design never answers or relays keys.")),
        Fragment(
            "design_workspace_supervision",
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("the design thread never answers a dialog."),
            Scaffold(" "),
            Operative("Structured supervision may record enough evidence to name the observed and recorded launch shapes, then orchestration alone adjudicates a residual prompt under a matching durable policy rule."),
            Scaffold(" "),
            Operative("If no rule matches, escalation is the only action.")),
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("orchestration may adjudicate only when this exact prompt class and agent kind are recorded in the durable per-team policy; design never answers it.")),
        Fragment("design_workspace_supervision", Descriptive("command approvals verified read-only")),
        Fragment(
            "design_workspace_supervision",
            Operative("orchestration may adjudicate only when the durable policy names this exact class and agent kind."),
            Scaffold(" "),
            Operative("Anything unmatched escalates; design never answers it.")),
        Fragment("design_workspace_supervision", Descriptive("trust screens for hooks the design thread itself installed")),
        Fragment(
            "design_workspace_supervision",
            Operative("the recorded recipe should eliminate this routine screen."),
            Scaffold(" "),
            Operative("If it remains, orchestration may adjudicate only under an exact durable policy match; design never accepts it.")),
        Fragment("design_workspace_supervision", Descriptive("operator-preauthorized mode changes")),
        Fragment(
            "design_workspace_supervision",
            Operative("the operator must have recorded this exact agent-kind and prompt-class pair before the wait."),
            Scaffold(" "),
            Operative("Orchestration owns adjudication; design never relays the resulting key.")),
