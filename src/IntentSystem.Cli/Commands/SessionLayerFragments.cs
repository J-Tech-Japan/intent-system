...
internal static class SessionLayerFragments
{
    ...
    [
        ...
        Fragment(
            S1,
            Operative("> **Detection and escalation boundary (G682):** the design thread never answers a dialog."),
            Scaffold(" "),
            Operative("Structured supervision may record launch-shape evidence, but no prompt-class producer exists until G683; every residual prompt is escalate-only by construction and every recorded rule is loudly inapplicable.")),
        Fragment(
            S1,
            Descriptive("- **confirmations of work the design thread itself requested** — verify:"),
            Scaffold(" "),
            Operative("until G683, escalate the residual prompt; a recorded rule cannot apply without a producer, and design never answers it.")),
        Fragment(
            S1,
            Descriptive("- **command approvals verified read-only** — verify:"),
            Scaffold(" "),
            Operative("until G683, every residual prompt escalates because no producer can supply a class; design never answers it.")),
        Fragment(
            S1,
            Descriptive("- **trust screens for hooks the design thread itself installed** — verify:"),
            Scaffold(" "),
            Operative("eliminate it through agent-side allow configuration recorded in the G636 kind recipe fields."),
            Scaffold(" "),
            Operative("If it remains, escalate it and never answer it.")),
        Fragment(
            S1,
            Descriptive("- **operator-preauthorized mode changes** — verify:"),
            Scaffold(" "),
            Operative("preauthorization does not make an inert rule operative."),
            Scaffold(" "),
            Operative("Until G683, residual prompts still escalate; neither orchestration nor design fabricates a class or relays an answer.")),
