...
internal static class SessionLayerFragments
{
    ...
    [
        ...
        Fragment(
            ...
            Scaffold(" "),
            Operative("It answers a blocking dialog only inside an explicit boundary and only after READING that dialog from the pane; everything outside the boundary escalates to the operator."),
            Scaffold(" "),
        ...
        Fragment(S1, Operative("- BLOCKING DIALOGS — answer only what the MAY list allows, only after the verified read; escalate everything else.")),
        Fragment(
            S1,
        ...
        Fragment(S1, Transport("- Prefer the least invasive repair that restores liveness: answer an in-boundary dialog, re-arm delivery, or restart the session — replacement is the last step, not the first.")),
        Fragment(
            S1,
        ...
        Fragment(
            S1,
            Operative("- note — Scanning is READING, and what the scan finds routes by STATE, not by one rule for everything."),
            Scaffold(" "),
            Operative("A blocking dialog goes to the dialog rules below — answer only what the MAY list covers after the verified read, and escalate the rest."),
            Scaffold(" "),
        ...
        Fragment(
            ...
            Scaffold(" "),
            Operative("Recovery: handle it under the dialog rules — answer only what the MAY list covers after the verified read, escalate the rest.")),
        Fragment(
            S1,
        ...
        Fragment(
            S1,
            Operative("> **Verified read before answer:** the design thread may answer a dialog ONLY after it has actually read that dialog's content from the pane and can state what it is approving."),
            Scaffold(" "),
            Operative("A blind keystroke into a dialog it has not rendered is prohibited, no matter how routine the prompt looks or how confident it is about which key clears it."),
            Scaffold(" "),
            Operative("If the content cannot be read or cannot be verified, the dialog is an escalation, not an answer.")),
        Fragment(
            S1,
            Operative("- **confirmations of work the design thread itself requested** — verify: the read pane's prompt must match an action THIS design thread just initiated — same target, same operation."),
            Scaffold(" "),
            Operative("A confirmation it cannot trace to its own request is not its to answer.")),
        Fragment(
            S1,
            Operative("- **command approvals verified read-only** — verify: the exact command shown in the pane must be read and verified to be READ-ONLY."),
            Scaffold(" "),
            Operative("Anything that writes, deletes, installs, publishes, or mutates state fails this check and escalates — \"probably read-only\" is not verified.")),
        Fragment(
            S1,
            Operative("- **trust screens for hooks the design thread itself installed** — verify: the trust screen must name a hook THIS design thread installed as part of this provisioning (its own hook-trust case)."),
            Scaffold(" "),
            Operative("A trust screen for anything it did not install is not its to accept.")),
        Fragment(
            S1,
            Operative("- **operator-preauthorized mode changes** — verify: the operator must have PREAUTHORIZED this specific mode change, and the read pane must show that same change."),
            Scaffold(" "),
            Operative("Preauthorization is specific and prior — it is never inferred from a general grant to supervise sessions.")),
        ...
        Fragment(
            S1,
            Operative("- **credential, security, and permission waits** — these are NEVER answerable by the design thread, with or without prior authorization: they always remain unanswered and always escalate to the operator."),
            Scaffold(" "),
    ...
    [
        ...
        Fragment("design_workspace_supervision", Operative("BLOCKING DIALOGS — answer only what the MAY list allows, only after the verified read; escalate everything else.")),
        Fragment(
            "design_workspace_supervision",
        ...
        Fragment("design_workspace_supervision", Transport("Prefer the least invasive repair that restores liveness: answer an in-boundary dialog, re-arm delivery, or restart the session — replacement is the last step, not the first.")),
        Fragment(
            "design_workspace_supervision",
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("Scanning is READING, and what the scan finds routes by STATE, not by one rule for everything."),
            Scaffold(" "),
            Operative("A blocking dialog goes to the dialog rules below — answer only what the MAY list covers after the verified read, and escalate the rest."),
            Scaffold(" "),
            Operative("An `agent-absent` shell prompt is NOT a dialog and must never be routed through dialog handling: it goes to the shim-safe relaunch recovery (recreating the app-server when that is what died), followed by the COMPLETE verified-liveness re-check — report, settle delay, all three checks."),
        ...
        Fragment("design_workspace_supervision", Operative("handle it under the dialog rules — answer only what the MAY list covers after the verified read, escalate the rest.")),
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("the design thread may answer a dialog ONLY after it has actually read that dialog's content from the pane and can state what it is approving."),
            Scaffold(" "),
            Operative("A blind keystroke into a dialog it has not rendered is prohibited, no matter how routine the prompt looks or how confident it is about which key clears it."),
            Scaffold(" "),
            Operative("If the content cannot be read or cannot be verified, the dialog is an escalation, not an answer.")),
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("the read pane's prompt must match an action THIS design thread just initiated — same target, same operation."),
            Scaffold(" "),
            Operative("A confirmation it cannot trace to its own request is not its to answer.")),
        Fragment("design_workspace_supervision", Descriptive("command approvals verified read-only")),
        Fragment(
            "design_workspace_supervision",
            Operative("the exact command shown in the pane must be read and verified to be READ-ONLY."),
            Scaffold(" "),
            Operative("Anything that writes, deletes, installs, publishes, or mutates state fails this check and escalates — \"probably read-only\" is not verified.")),
        Fragment("design_workspace_supervision", Descriptive("trust screens for hooks the design thread itself installed")),
        Fragment(
            "design_workspace_supervision",
            Operative("the trust screen must name a hook THIS design thread installed as part of this provisioning (its own hook-trust case)."),
            Scaffold(" "),
            Operative("A trust screen for anything it did not install is not its to accept.")),
        Fragment("design_workspace_supervision", Descriptive("operator-preauthorized mode changes")),
        Fragment(
            "design_workspace_supervision",
            Operative("the operator must have PREAUTHORIZED this specific mode change, and the read pane must show that same change."),
            Scaffold(" "),
            Operative("Preauthorization is specific and prior — it is never inferred from a general grant to supervise sessions.")),
        ...
        Fragment(
            "design_workspace_supervision",
            Operative("these are NEVER answerable by the design thread, with or without prior authorization: they always remain unanswered and always escalate to the operator."),
            Scaffold(" "),
            Operative("No grant makes them answerable.")),
        Fragment(
            "design_workspace_supervision",
