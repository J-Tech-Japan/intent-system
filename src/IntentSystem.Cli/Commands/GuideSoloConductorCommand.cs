        ...
        [
            ...
            new SoloConductorLoopStep
            {
                ...
                [
                    ...
                    IntentCli("intent-cli review cross-runtime request --kind design --execution-unit <unit> --runtime <codex|claude|cursor> --out-dir <out-dir> [--clone <read-only-clone>] [--model <model>] --format json"),
            ...
            new SoloConductorLoopStep
            {
                ...
                Commands =
                [
                    IntentCli("intent-cli review cross-runtime request --repo <owner/repo> --pr <pr> --head-sha <head-sha> --execution-unit <unit> --runtime <codex|claude|cursor> --clone <read-only-clone> --out-dir <out-dir> [--model <model>] --format json"),
