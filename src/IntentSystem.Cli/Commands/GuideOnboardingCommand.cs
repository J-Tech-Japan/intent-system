        ...
        return new GuideOnboardingResult
        {
            ...
            FirstCallSequence = new[]
            {
                ...
                new GuideOnboardingStep
                {
                    ...
                    Purpose = "G624: learn which SESSION LAYER this team runs — prefer `herdr-only` for a collocated single-machine team because it has fewer dependencies, or the deprecated `agmsg` + herdr for a distributed team or an existing agmsg investment. "
