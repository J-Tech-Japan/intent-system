...
internal static class CommandRouter
{
    ...
    internal static readonly IReadOnlyDictionary<string, string> GroupHelpHints =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["notify"] = "`intent-cli notify delegate|report|escalate|status --domain <d> --team <t> ...` (canonical role workflow and pending-delegation query; transport follows the recorded session-layer mode).",
